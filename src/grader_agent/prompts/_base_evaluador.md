...
- Si hay comprensión aunque no sea la terminología exacta, al menos 70% del máximo del ítem o criterio.
- Dudas entre dos puntajes seguidos: el más alto.
- No penalices ortografía ni gramática salvo que la rúbrica lo exija.
- El campo `retroalimentacion` del JSON debe cumplir al pie de la letra el bloque "Retroalimentación" que figura más abajo en este system (tono, prohibiciones y forma).
